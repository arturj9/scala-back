...
@ApiTags('Hábitos') // Agrupa no Swagger
@ApiBearerAuth() // Indica que todas as rotas precisam de token
@UseGuards(AuthGuard)
@Controller('habits')
export class HabitsController {
  ...
  async findAll(@Request() req, @Query() query: ListHabitsDto) {
  ...
  async getGeneralHistory(@Query() query: DateRangeDto, @Request() req) {
